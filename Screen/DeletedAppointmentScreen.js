...
const DeletedAppointmentScreen = () => {
  ...
  useEffect(() => {
    ...
    appointmentRef.onSnapshot((querySnapshot) => {
      const appointments = [];
      //i want to add a where clause here
      ...
      <Modal visible={selectedAppointment !== null} animationType="slide">
        {selectedAppointment && (
          <View style={styles.modal}>
            ...
            <Text style={styles.modalText}>
              Contact Number: {selectedAppointment.contactNumber}
            </Text>
            <Text style={styles.modalText}>
...
const styles = StyleSheet.create({
  ...
  acceptButton: {
    ...
    width: 100,
    alignItems: "center",
    opacity: 0.4, // add opacity to make it look deleted
  },
  acceptButtonText: {
    color: "white",
    fontWeight: "bold",
    textDecorationLine: "line-through", // add strikethrough to text
  },
  declineButton: {
...
export default DeletedAppointmentScreen;
